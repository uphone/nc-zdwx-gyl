...
public class CtPuBVO extends CtAbstractBVO {
  ...
  //start <<<  add by zip 20191224 添加自定义项（5个）
  ...
  public void setVbdef22(String vbdef22) {
    this.setAttributeValue(CtPuBVO.VBDEF22, vbdef22);
  }
  ...
  public void setVbdef23(String vbdef23) {
    this.setAttributeValue(CtPuBVO.VBDEF23, vbdef23);
  }
  ...
  public void setVbdef24(String vbdef24) {
    this.setAttributeValue(CtPuBVO.VBDEF24, vbdef24);
  }
  ...
  public void setVbdef25(String vbdef25) {
    this.setAttributeValue(CtPuBVO.VBDEF25, vbdef25);
  }
  // >>> end
}
